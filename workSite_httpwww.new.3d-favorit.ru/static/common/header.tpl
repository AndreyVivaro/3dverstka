                    ...
                    <?php foreach (array_chunk($category['children'], ceil(count($category['children']) / $category['column'])) as $children) { ?>
                      <?php foreach ($children as $child) { ?>
                        <li><a class="menu-catalog__sub-menu-href" href="<?php echo $child['href']; ?>">
                            <div class="menu-catalog__sub-menu-icon"><img src="<?php echo $child['thumb']; ?>" alt="иконка пункта подменю"></div><span class="menu-catalog__sub-menu-text"><?php echo $child['name']; ?></span>
                          </a></li>
                      <?php } ?>
                    <?php } ?>
                  </ul>
