<div id="popup-quickorder" class="cd-popup is-visible">

	<div class="popup-center">

          <div class="cont-modal">
            <p class="descr-modal">Быстрый заказ</p>
            <div class="fields-modal">
            
			<form id="fastorder_data" enctype="multipart/form-data" method="post">
			 <div class="wrap-products-modal">
                <div class="product-info-basket-modal"><img class="product-info-basket-modal-img" src="<?php echo $thumb_small; ?>" alt="<?php echo $heading_title; ?>">
                  <p class="product-info-basket-modal-name"><?php echo $heading_title; ?></p>
                  <div class="wrap-recount">
					<input class="wrap-recount__recount-minus" type="button" id="decrease_quickorder" value="-" onclick="btnminus_quickorder('1');recalculateprice_quickorder();" />									
					<input class="wrap-recount__recount-input input-sm qty_quickorder" type="number" name="quantity" id="htop_quickorder" size="2" value="1" />								
					<input class="wrap-recount__recount-plus" type="button" id="increase_quickorder" value="+" onclick="btnplus_quickorder();recalculateprice_quickorder();" />
                  </div>
				  ...
				  <span id="formated_price_quickorder" class="number-space-js" data-price="<?php echo $price_value; ?>"><?php echo $price; ?></span>
...
<div class="option-fastorder">				
    <div class="options">      
        <?php foreach ($options as $option) { ?>
            ...
            <div id="option-fast-<?php echo $option['product_option_id']; ?>" class="col-sm-6 col-xs-12 option form-group<?php echo ($option['required'] ? ' required' : ''); ?>" style="padding: 0px;">
              <div class="text-danger option-error-<?php echo $option['product_option_id']; ?>"></div>
...
<?php } ?>
              ...
              <div class="wrap-field-modal">
                <p class="text-field-modal">Имя</p>
             <input id="contact-name" class="contact-name" type="text" placeholder="<?php echo $config_placeholder_fields_firstname[$lang_id]['config_placeholder_fields_firstname']; ?>" value="" name="name_fastorder">		
              </div>
              <div class="wrap-field-modal">
                <p class="text-field-modal">*Телефон:</p>
				<input id="contact-phone" class="contact-phone" type="text" placeholder="<?php echo $config_placeholder_fields_phone[$lang_id]['config_placeholder_fields_phone']; ?>" value="" name="phone">		
              </div>
              <div class="wrap-field-modal">
                <p class="text-field-modal">*E-mail:</p>
              ...
              <div class="wrap-field-modal">
                <p class="text-field-modal">Комментарий:</p>
                <textarea id="contact-comment" class="contact-comment-buyer" name="comment_buyer" id="contact_comment_buyer" ></textarea>
              </div>
		...
		<input type="hidden" id="this_prod_id" value="<?php echo $product_id;?>" name="this_prod_id"  />
              ...
              <div class="wrap-button-modal">
                ...
                <button class="button" onclick="quickorder_confirm();">Оформить заказ</button>
              </div>
            </div>
          </div>
