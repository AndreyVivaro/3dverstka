  ...
  <?php } ?>
        ...
        <fieldset style="padding-left: 0px;">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-firstname" style="padding-left: 0px;"><?php echo $entry_firstname; ?> </label>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-lastname" style="padding-left: 0px;"><?php echo $entry_lastname; ?></label>
            <div class="col-sm-10" style="padding-left: 0px;">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-email" style="padding-left: 0px;"><?php echo $entry_email; ?></label>
            <div class="col-sm-10" style="padding-left: 0px;">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-telephone" style="padding-left: 0px;"><?php echo $entry_telephone; ?></label>
            <div class="col-sm-10" style="padding-left: 0px;">
