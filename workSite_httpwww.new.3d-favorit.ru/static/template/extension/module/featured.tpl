<?php if ($heading_title=='Популярные товары') { ?>
<div class="col-xl-4 col-lg-8 col-md-12 item-category-product">
                <div class="slider-product-cart">
                  <div class="slider-product-cart__title title-dotted-min">Популярные товары</div>
...
<?php if ($heading_title=='Рекомендуемые в товаре') { ?>
<section class="recommendedProduct section-padding">
          <div class="container">
            <div class="row">
              <div class="col-xl-12">
                <h2 class="section-title title-dotted">Рекомендуемые товары</h2>
              </div>
            </div>
